...
@NamedQueries({
    ...
    @NamedQuery(name = "ActivityData.findActivityDataForGroupInDateRange", query = "SELECT a FROM ActivityData a WHERE a.userId.groupId.idGroup = :id AND a.categoryUnitId.unitId.name = :unit AND a.date >= :startDate AND a.date <= :endDate"),
    @NamedQuery(name = "ActivityData.findActivityDataForCommunityInDateRange", query = "SELECT a FROM ActivityData a WHERE a.userId.groupId.communityId.idCommunity = :id AND a.categoryUnitId.unitId.name = :unit AND a.date >= :startDate AND a.date <= :endDate")})
